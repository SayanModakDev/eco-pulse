    ...
    return (
      ...
      >
        ...
        <p className="text-slate-500 mt-2 text-sm">
          No challenges available. Submit an activity above to identify
          emissions and generate micro-challenges.
        </p>
      </section>
    );
  }
      ...
      <header className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1">
            Complete these recommended micro-challenges targeting your highest
            emission vectors.
          </p>
        </div>
      </header>
