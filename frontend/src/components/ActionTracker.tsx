 ...
 */
const ActionTracker = React.memo(
  ({ onTrack, isLoading }: ActionTrackerProps) => {
      ...
      >
        <header className="mb-4">
          ...
          <p className="text-sm text-slate-400 mt-1">
            Describe your daily actions in natural language (e.g., &quot;I drove
            15km in my car and ate a beef burger&quot;).
          </p>
        </header>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div id="input-hint" className="sr-only">
              Describe your transportation, food, waste, or energy use today.
              Max 2000 characters.
            </div>
          </div>
